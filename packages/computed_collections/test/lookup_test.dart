...
void main() {
  ...
  test('propagates the change stream', () async {
    ...
    expect(
        lastRes,
        KeyChanges({
          0: ChangeRecordValue((1, null)),
          1: ChangeRecordValue((2, 3))
        }.lock));
    ...
    expect(callCnt, 3);
    expect(lastRes,
        ChangeEventReplace({0: (1, null), 1: (2, null), 2: (3, null)}.lock));
    ...
    expect(callCnt, 4);
    expect(
        lastRes, ChangeEventReplace({0: (1, null), 1: (2, 1), 2: (3, 2)}.lock));
    ...
    expect(callCnt, 5);
    expect(lastRes, KeyChanges({1: ChangeRecordValue((2, null))}.lock));
